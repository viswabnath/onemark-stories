        ...
        <div className="about__grid" style={{ marginBottom: "6rem" }}>
          <div>
            ...
            <div className="about__ctas">
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="whatsapp-btn" data-hover style={{ background: "linear-gradient(135deg, var(--rose) 0%, var(--gold) 100%)", border: "none", boxShadow: "0 4px 15px rgba(150,34,43, 0.25)" }}>
